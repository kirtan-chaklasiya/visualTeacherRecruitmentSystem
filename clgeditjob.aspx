...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        <br />
        <center><asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="18pt" Text="Edit Jobs"></asp:Label></center>
    </p>
    <table class="auto-style1">
        ...
        <tr>
            <td>&nbsp;</td>
            <td>
                <asp:Button ID="btnupdate" runat="server" Text="Update" style="height: 26px" OnClick="btnupdate_Click" CssClass="tsubmit" />
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
